...
const mutations = {
    ...
    verifyEmail: (parent_1, _a, ctx_1) => __awaiter(void 0, [parent_1, _a, ctx_1], void 0, function* (parent, { input }, ctx) {
        ...
        try {
            ...
            const userToken = JWTService_1.default.generateTokenForUser({ id: user.id, username: user.username, language: "Hindi" });
    ...
    loginUser: (parent_1, _a, ctx_1) => __awaiter(void 0, [parent_1, _a, ctx_1], void 0, function* (parent, { input }, ctx) {
        ...
        try {
            ...
            const userToken = JWTService_1.default.generateTokenForUser({ id: existingUser.id, username: existingUser.username, language: existingUser.language });
